...
![Install Threads integration](./img/threads-install.png)
...
![Threads alert rule action settings](./img/threads-rule.png)
...
![Threads metric alert rule firing and resolving](./img/threads-metric-alert.png)
...
By default, the feature comes as enabled for both options.
